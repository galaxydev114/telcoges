...
class DefaultSettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $defaultInvoiceEmailBody = 'Ha recibido una nueva factura de <b>{COMPANY_NAME}</b>.</br>Descargue usando el botón de abajo:';
        $defaultEstimateEmailBody = 'Ha recibido un nuevo presupuesto de <b>{COMPANY_NAME}</b>.</br>Please download using the button below:';
        $defaultPaymentEmailBody = 'Gracias por el pago.</b></br>Descargue su recibo de pago usando el botón a continuación:';
